...
const paymentVerification = asyncHandler(async(req,res)=>{
    ...
    try {
        ...
        res.redirect(`http://34.28.192.168/PaymentSuccess`) // adding the backend url for smnooth tenasition

        }else{
            res.redirect(`http://34.28.192.168/PaymentFailure`)
...
const subPaymentVerification = asyncHandler(async(req,res)=>{
    ...
    try {
        ...
        console.log("we reached here")
        res.redirect(`http://34.28.192.168/PaymentSuccess`)
